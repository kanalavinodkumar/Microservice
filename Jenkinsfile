pipeline {
    ...
    stages {
        stage('Deploy') {
            steps {
                withKubeCredentials(kubectlCredentials: [[caCertificate: '', clusterName: 'vinodhub.online', contextName: '', credentialsId: 'k8-token', namespace: 'webapps', serverUrl: 'https://api.vinodhub.online']]) {
